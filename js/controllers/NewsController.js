...
ApolloApp.controller('NewsController', ['$rootScope', '$scope', '$http', '$timeout','QueryService', '$firebaseObject', function($rootScope, $scope, $http, $timeout, QueryService, $firebaseObject) {
